...
public class ShoppingCarAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        new ImageFromUrl(imgFoto).execute(iceCream.getImageUrl());
        tvRecipiente.setText("Recipiente: " + iceCream.getContainer());
        tvSabores.setText("Sabores: " + iceCream.getFlavor());
        tvPrecio.setText("Bs " + iceCream.getPrice());
        return view;
    }
